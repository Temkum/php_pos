                ...
                <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                    <div class="row">
                        <div class="col-sm-12 table-responsive">
                            <table id="example1" class="table table-bordered table-striped dataTable dtr-inline tables"
                        ...
                        $item = null;
                        $value = null;
                        $categories = CategoriesController::displayCategories($item, $value);
                        ...
                        foreach ($categories as $key => $cat) {
                          ...
                          <td>'.$cat['created_at'].'</td>';
                            echo '<td class="action">
                                <button class="btn btn-warning btn-sm editCatBtn" data-toggle="modal" data-target="#editCategory">
