...
<!-- Edit category Modal -->
<div class="modal fade" id="editCategories" tabindex="-1" aria-labelledby="exampleModalLabel" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
        <div class="modal-header mb-3">
        ...
        <form method="POST">
          <div class="form-row align-items-center">
            <div class="col-auto">
              ...
              <div class="input-group mb-2">
                ...
                <input type="text" class="form-control" name="editCategory" id="editCategory" required>
                <input type="hidden" name="idCat" id="categoryID" required>
              </div>
            </div>
          ...
          <?php
              $cat_edit = new CategoriesController();
              $cat_edit->update();
          ?>
        </form>
      </div>
